...
interface EmailInvoiceDialogProps {
  ...
  totalAmount?: string;
  type?: string;
  senderEmail?: string; // Email of the logged-in user sending the invoice
  loading?: boolean;
  title?: string;
}
...
export const EmailInvoiceDialog: React.FC<EmailInvoiceDialogProps> = ({
  ...
  // Update state when props change (when a new invoice is selected)
  useEffect(() => {
    setTo(customerEmail || '');
    setCc(senderEmail || '');
    setSubject(`Invoice ${invoiceNumber}`);
    setMessage(`Please find attached invoice ${invoiceNumber}.`);
  }, [customerEmail, senderEmail, invoiceNumber]);
            ...
            <View style={styles.recipientsDisplay}>
              ...
              <View style={styles.recipientRow}>
                ...
                <View style={styles.recipientInfo}>
                  ...
                  <Text style={styles.recipientEmail}>{to || 'customer@example.com'}</Text>
                </View>
              </View>
