...
const getStatusColor = (status: string) => {
    const colors: Record<string, string> = {
        ...
        'planning': '#9C27B0', 'on-hold': '#FF9800',
    };
...
export const ProjectsScreen: React.FC = () => {
    ...
    const handleDelete = async () => {
        ...
        try {
            await api.projects.delete(selectedRecord.id.toString());
    ...
    const renderCard = ({ item }: { item: Project }) => (
        <Card
            ...
            onPress={() => navigation.navigate('ProjectForm' as any, { projectId: item.id } as any)}
        >
            <Card.Content>
                ...
                <View style={styles.cardBody}>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text variant="bodySmall" style={{ color: themeColors.text.secondary }}>
                            Billed: ₹{Number(item.billedAmount).toFixed(2)}
                        </Text>
                    </View>
                </View>
        ...
        <MainLayout currentRoute="Projects" title="Projects" onNavigate={handleNavigate}>
            <View style={[styles.container, { backgroundColor: themeColors.background.main }]}>
                        ...
                        <FlatList
                            ...
                            ListEmptyComponent={
                                <View style={styles.emptyContainer}>
                                    ...
                                    <Button
                                        mode="contained"
                                        onPress={() => navigation.navigate('ProjectForm' as any)}
                ...
                <Portal>
                    ...
                    >
                        <Dialog.Title style={{ color: themeColors.text.primary }}>Delete Project</Dialog.Title>
                        <Dialog.Content>
                            <Paragraph style={{ color: themeColors.text.secondary }}>
                                Are you sure you want to delete {selectedRecord?.projectNumber}?
                            </Paragraph>
                        </Dialog.Content>
                        <Dialog.Actions>
